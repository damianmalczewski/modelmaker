 ...
 * JacksonConfig#withOverride} then keeps the project default. Created through {@link #none()} /
...
public final class JacksonOverride {
   ...
   * @return the override.
   */
  static JacksonOverride of(
      @Nullable Boolean enabled,
      @Nullable Boolean annotateFields,
      @Nullable Boolean annotateGetters) {
    return new JacksonOverride(enabled, annotateFields, annotateGetters);
  }
