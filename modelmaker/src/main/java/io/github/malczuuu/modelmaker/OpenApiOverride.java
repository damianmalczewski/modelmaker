...
public final class OpenApiOverride {
  ...
  private static final OpenApiOverride NONE = new OpenApiOverride(null, null, null);
   ...
   * @return the override.
   */
  static OpenApiOverride enabled(boolean value) {
    return new OpenApiOverride(value, null, null);
  }
  ...
  public boolean equals(@Nullable Object obj) {
    ...
    if (!(obj instanceof OpenApiOverride other)) {
      return false;
    }
