...
/**
 * The {@code openApi} feature: whether its OpenAPI {@code @Schema} annotations are emitted, and
 * where they sit.
 *
 * <pre>
 * &lt;openApi&gt;
...
public class OpenApiFeature {
  ...
  /** Creates a new {@link OpenApiFeature}, turned off and annotating the getters once enabled. */
